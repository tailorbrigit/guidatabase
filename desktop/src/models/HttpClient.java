...
public class HttpClient 
{
    ...
    public String get(String urlStr) 
    {
        ...
        {
            String msg = "Hiba! A metódus hibás";
    ...
    public String post(String url, String data, HashMap<String, String> headers) 
    {
        ...
        {
            String msg = "Hiba! Nem elérhető a REST API!";
            System.err.println(msg);
            result = msg;
        }
        return result;
    }
    public String tryPost(String urlStr, String data, HashMap<String, String> headers) throws IOException 
    {
        URL url = new URL(urlStr);
        HttpURLConnection http = (HttpURLConnection) url.openConnection();
        ...
        {
            http.setRequestGuidatabase(entry.getKey(), entry.getValue());
        }
    ...
    private String convertInputStreamToString(InputStream inputStream) 
    {
        ...
        try 
        {
         ...
         {
            String msg = "Hiba! A kódolás nem támogatott";
            System.err.println(msg);
            text = msg;
        }
        return text;
